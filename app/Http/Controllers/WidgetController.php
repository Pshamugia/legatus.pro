...
(function(){
 ...
 var frameUrl={$frameJson},frameOrigin=(new URL(frameUrl)).origin;
 var root=document.createElement('div');root.id='legatus-widget-root';root.innerHTML='<button aria-label="Open Legatus shopping assistant" id="legatus-launcher"><span>L</span><b>Ask Legatus</b></button>';
 var frame=document.createElement('iframe');frame.title='Legatus AI sales assistant';frame.id='legatus-frame';frame.src=frameUrl;frame.allow='clipboard-write';root.appendChild(frame);
