...
(function(){
 ...
 var frameUrl={$frameJson},frameOrigin=(new URL(frameUrl)).origin,businessName={$businessNameJson},businessInitial={$businessInitialJson};
