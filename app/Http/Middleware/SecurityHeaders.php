...
class SecurityHeaders
{
    public function handle(Request $request, Closure $next): Response
    {
        ...
        $frameAncestors = $widget ? $this->widgetFrameAncestors() : "'none'";
    ...
    private function widgetFrameAncestors(): string
    {
        $configured = preg_split('/[\s,]+/', trim((string) config('legatus.widget_frame_ancestors', '*'))) ?: [];
