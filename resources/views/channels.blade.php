                    ...
                    @if($canManageChannels)
                        @unless($commerceConnection?->status === 'active')
                            <div class="connector-guide">
                                <b>საიდან მივიღო Connector Key ID და Shared secret?</b>
                                <p>ეს არ არის OpenAI-ის ან Facebook-ის გასაღები. მას თქვენი მაღაზიის Legatus connector ქმნის. Bukinistebi/Laravel connector-ზე სერვერის Terminal-ში გაუშვით:</p>
                                <code>php artisan legatus:connector-setup --write</code>
                                <p>ბრძანება გაჩვენებთ ზუსტად ამ ორი ველის მნიშვნელობას. Shared secret პაროლივით დაიცავით.</p>
                            </div>
                        @endunless
