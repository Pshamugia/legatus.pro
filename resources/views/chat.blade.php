...
<div class="chatpage"><div class="chatwindow">
    ...
    <div id="messages"><div class="bubble ai">Hello! 👋 {{ $assistantIntroduction }} I can help you choose products, verify prices and availability, arrange delivery, and handle wholesale inquiries. What are you looking for?</div></div>
    <div class="suggestions"><button data-q="I'm looking for a modern, mysterious book similar to The Master and Margarita for up to 30 GEL.">✨ Personal shopper</button><button data-q="How much does Piranesi cost, and are two copies in stock?">💸 Price + stock</button><button data-q="Can it be delivered to Tbilisi tomorrow?">🚚 Delivery</button><button data-q="I'd like 10 copies of Convenience Store Woman and want to request an 18% discount.">📦 Wholesale offer</button><button data-q="Connect me with a human operator.">🙋 Human handoff</button></div>
    <form class="composer" id="chat-form"><input id="message" autocomplete="off" maxlength="1500" placeholder="Write a message..."><button class="btn" type="submit">Send ↑</button></form>
</div></div>
