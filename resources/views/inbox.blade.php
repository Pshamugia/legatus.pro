...
<script nonce="{{ request()->attributes->get('csp_nonce') }}">
    ...
    const addMessage = (message) => {
        if (messagePane.querySelector(`[data-message-id="${message.id}"]`)) return false;
