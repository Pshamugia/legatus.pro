...
<div class="dash-shell"><aside class="side"><a class="brand" href="/"><span class="mark">L</span> Legatus</a><div class="menu"><a href="{{ route('dashboard') }}">◫ &nbsp; Overview</a><a href="{{ route('inbox.index') }}">◌ &nbsp; Inbox</a><a class="active" href="{{ route('knowledge.index') }}">◇ &nbsp; Knowledge</a><a href="{{ route('dashboard') }}#products">▦ &nbsp; Products</a><a href="{{ route('channels.index') }}">⌁ &nbsp; Channels</a><a href="{{ route('analytics.index') }}">↗ &nbsp; Analytics</a><a href="{{ route('settings.index') }}">⚙ &nbsp; Settings</a></div><div class="side-bottom"><b style="color:white">Knowledge safety</b><br>Only verified sources ground answers.</div></aside>
