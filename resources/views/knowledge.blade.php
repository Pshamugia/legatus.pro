...
<section class="panel knowledge-section knowledge-section--catalog">
    ...
    <form id="website-structure-form" method="post" action="{{ route('knowledge.store') }}">
        ...
        <div class="knowledge-group knowledge-group--languages"><div class="knowledge-group__title"><div><label>3. Website languages</label><p>Add one public catalog URL for every website language.</p></div><button type="button" class="btn ghost" id="add-language">＋ Add language</button></div><div id="language-fields"></div></div>
        <div class="knowledge-group knowledge-group--categories"><div class="knowledge-group__title"><div><label>4. Categories</label><p>Give every category its public name and URL. The first five are shown initially.</p></div><button type="button" class="btn ghost" id="add-category">＋ Add category</button></div><div id="category-feedback" class="category-feedback" role="status" aria-live="polite"></div><div id="category-fields"></div><button type="button" class="btn ghost category-list-toggle" id="toggle-categories" aria-expanded="false" aria-controls="category-fields"></button></div>
        <div class="knowledge-group knowledge-group--sitemap" @if($sitemapSource) data-source-row="{{ $sitemapSource->id }}" @endif>
...
<section class="panel knowledge-section knowledge-section--business">
...
<style>.business-knowledge-row{--item-accent:#547f70;padding:18px;border:1px solid #cbded6;border-left:4px solid var(--item-accent);border-radius:15px;background:#f1f8f5}.business-knowledge-row:nth-child(3n+2){--item-accent:#6e72a6;border-color:#d8d7e8;background:#f5f4fb}.business-knowledge-row:nth-child(3n){--item-accent:#a87537;border-color:#e5d7c1;background:#fbf6ed}.business-knowledge-row+.business-knowledge-row{margin-top:12px}.business-knowledge-row .eyebrow{color:var(--item-accent)}.business-knowledge-fields{display:grid;grid-template-columns:minmax(0,1fr) 180px;gap:12px}.business-knowledge-row textarea,.business-knowledge-row select{width:100%;box-sizing:border-box;border:1px solid var(--line);border-radius:12px;padding:12px;background:#fff;font:inherit}.business-knowledge-row textarea{resize:vertical}@media(max-width:700px){.business-knowledge-fields{grid-template-columns:1fr}}</style>
