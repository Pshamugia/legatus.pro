...
<div class="wrap">
    ...
    <main class="onboard">
        ...
        <form class="form-card setup-form" id="onboarding-form" method="post" enctype="multipart/form-data" action="{{ route('onboarding.store') }}">
            ...
            <section class="setup-step">
                <div class="setup-step-head"><span>4</span><div><h2>Catalog and business knowledge</h2><p>Provide a complete catalog URL, a CSV/PDF file, or both. Browsers cannot prefill a file input, so a blank chooser does not mean your previous upload disappeared.</p></div></div>
