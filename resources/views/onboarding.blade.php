...
<div class="dash-shell">
    @include('partials.workspace-navigation', ['active' => 'onboarding'])

    <main class="main setup-main">
        <div class="setup-intro">
            <span class="tag">Business details and customer channels</span>
        ...
        @include('partials.business-channels')
    </main>
</div>

<style>
.setup-main{max-width:1120px;width:100%;margin:0 auto}
