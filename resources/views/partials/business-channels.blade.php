    ...
    <article class="channel-block" id="website-channel">
        ...
        <div class="widget-installer">
            ...
            <div class="platform-guide">
                ...
                <div class="channel-snippet"><code id="widget-snippet">{{ $snippet }}</code><button class="btn lime" id="copy-snippet" type="button" data-default-label="Copy universal script">Copy universal script</button></div>
                <div class="installer-actions">
                    <button class="btn ghost" id="copy-developer-instructions" type="button" data-default-label="Copy instructions for developer">Copy instructions for developer</button>
                    @if($canManageChannels)
