...
@once
    <style nonce="{{ request()->attributes->get('csp_nonce') }}">
        ...
        @media(max-width:560px){.dash-shell>.main{padding:18px 14px}.app-mobile-controls{min-width:0}.app-mobile-controls>*{min-width:0}.app-mobile-controls>.brand{flex:0 0 auto;margin-right:0;font-size:0}.app-mobile-controls>.app-business-brand .app-business-brand-copy{display:none}.app-mobile-nav .workspace-switcher{width:auto;min-width:0;flex:1}.app-mobile-nav .workspace-switcher>summary{max-width:100%}.app-mobile-nav .workspace-summary-copy strong{max-width:100%;text-overflow:ellipsis}.app-mobile-nav .workspace-menu{right:-74px;width:min(88vw,310px)}.app-mobile-nav .workspace-avatar{display:none}.app-mobile-add-label,.app-mobile-logout-label{position:absolute;width:1px;height:1px;overflow:hidden;clip:rect(0,0,0,0)}.app-workspace-topbar>.brand{font-size:17px}.app-workspace-topbar .app-topbar-link{display:none}}
    </style>
@endonce
