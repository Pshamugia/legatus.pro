@php
    ...
    $navigationBusinessName = trim((string) ($navigationWorkspace?->name
        ?: $navigationAgent?->business_name
        ?: 'Your business'));
...
@once
    <style nonce="{{ request()->attributes->get('csp_nonce') }}">
        ...
        @media(max-width:850px){
            ...
            .dash-shell{display:block;width:100%;max-width:100vw;min-width:0;overflow-x:clip}
            .dash-shell>.main{width:100%;max-width:100%;min-width:0;overflow-x:clip}
            .dash-shell>.main>*{max-width:100%;min-width:0}
            .dash-shell>.main :where(section,article,aside,header,footer,form,fieldset,div){min-width:0}
            .dash-shell>.main :where(input,textarea,select,pre,table){max-width:100%}
            .dash-shell>.main :where(h1,h2,h3,p,pre,code){overflow-wrap:anywhere}
            .dash-shell>.main :where(pre,code){white-space:pre-wrap;word-break:break-word}
            .app-mobile-nav{width:100%;max-width:100vw}
            .app-mobile-controls{width:100%;max-width:100%;min-width:0}
            .app-mobile-controls>*{min-width:0}
            .app-mobile-links{width:100%;max-width:100%;overscroll-behavior-inline:contain}
            .topline{align-items:flex-start;flex-direction:column;gap:12px}
            .topline>*,.topline>*>*{max-width:100%;min-width:0}
            .topline h1{font-size:clamp(26px,8vw,36px);line-height:1.12;letter-spacing:-1.2px}
            .grid,.content-grid{width:100%;min-width:0}
            .stat,.panel,.form-card{max-width:100%;min-width:0}
        }
        @media(max-width:560px){
            .dash-shell>.main{padding:18px 14px}
            .grid{grid-template-columns:minmax(0,1fr)}
            .app-mobile-nav{padding-inline:10px}
            .app-mobile-controls{display:grid;grid-template-columns:auto minmax(0,1fr) auto auto auto;gap:6px}
            .app-mobile-controls>.brand{flex:0 0 auto;margin-right:0;font-size:0}
            .app-mobile-controls>.brand .mark{width:30px;height:30px;border-radius:10px}
            .app-mobile-controls>.app-business-brand .app-business-brand-copy{display:none}
            .app-mobile-nav .workspace-switcher{width:auto;min-width:0;max-width:100%}
            .app-mobile-nav .workspace-switcher>summary{max-width:100%;gap:5px;padding-inline:7px}
            .app-mobile-nav .workspace-summary-copy strong{max-width:100%;text-overflow:ellipsis}
            .app-mobile-nav .workspace-chevron{font-size:13px}
            .app-mobile-nav .workspace-menu{right:-142px;left:auto;width:min(calc(100vw - 20px),310px)}
            .app-mobile-nav .workspace-avatar{display:none}
            .app-mobile-nav .ui-locale{gap:1px;padding:2px}
            .app-mobile-nav .ui-locale button{padding:5px 7px;font-size:10px}
            .app-mobile-nav .app-add-business,.app-mobile-nav .app-logout{min-width:30px;padding:6px}
            .app-mobile-add-label,.app-mobile-logout-label{position:absolute;width:1px;height:1px;overflow:hidden;clip:rect(0,0,0,0)}
            .app-mobile-links{padding-top:8px}
            .app-mobile-links a{padding:7px 8px}
            .app-workspace-topbar>.brand{font-size:17px}
            .app-workspace-topbar .app-topbar-link{display:none}
            .conversation{max-width:100%;min-width:0;flex-wrap:wrap}
            .conversation .copy{min-width:0}
            .conversation p{max-width:100%}
        }
    </style>
@endonce
