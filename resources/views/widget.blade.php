    ...
    function add(text, role, products = [], meta = {}) {
        ...
        if (products.length) {
            ...
            products.forEach(product => {
                ...
                if (!inStock) card.classList.add('sold-out');
                if (productUrl) {
