...
class OnboardingGoldenPathTest extends TestCase
{
    ...
    public function test_onboarding_updates_the_workspace_and_learns_url_and_catalog(): void
    {
        ...
        $this->actingAs($user)->post('/onboarding', ['business_name' => 'Golden Store', 'website' => 'https://example.com/store', 'description' => 'A polished demo business.', 'catalog' => $catalog])->assertRedirect('/app');
