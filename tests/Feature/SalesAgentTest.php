...
class SalesAgentTest extends TestCase
{
    ...
    public function test_landing_page_is_available(): void
    {
        $this->get('/')
            ...
            ->assertSee('steward')
            ->assertSee('billed every 6 months · save $18 ($27/month)')
            ->assertSee('billed every year · save $72 ($24/month)')
            ->assertSee('data-social-note="Chat + Social · billed every 6 months · save $36 ($54/month)"', false)
            ->assertSee('data-social-note="Chat + Social · billed every year · save $144 ($48/month)"', false)
