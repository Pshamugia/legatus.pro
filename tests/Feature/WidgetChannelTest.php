...
class WidgetChannelTest extends TestCase
{
    ...
    public function test_channels_page_contains_installation_snippet(): void
    {
        ...
        $this->get('/onboarding')
            ...
            ->assertSee('data-default-label="Copy universal script"', false)
            ->assertSee('data-default-label="Copy instructions for developer"', false)
            ->assertSee("target.textContent='Copied ✓'", false)
            ->assertSee("target.textContent='Copy failed'", false)
